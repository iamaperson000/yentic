        ...
        <footer className="border-t border-white/10 bg-black/40 py-10">
          <div className="mx-auto flex max-w-5xl flex-col gap-2 px-6 text-sm text-white/50">
            ...
            <p className="text-white/40">
              Visit <a className="underline decoration-emerald-400/60 underline-offset-4 hover:text-white" href="https://yentic.com" target="_blank" rel="noreferrer">yentic.com</a> to follow the journey.
            </p>
          </div>
        </footer>
      </div>
